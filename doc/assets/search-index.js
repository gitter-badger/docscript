...
/***/ function(module, exports, __webpack_require__) {
	...
	var index = void 0;
	function initSearchIndex(payload) {
	    var settings = payload.settings;
	
	    importScripts(settings.assetsRoot + '/search-index-lib.js');
	    var _window$__search_inde = window.__search_index_lib__;
	    var buffer = _window$__search_inde.buffer;
	    var stream = _window$__search_inde.stream;
	    var level = _window$__search_inde.level;
	    var si = _window$__search_inde.si;
	
	    var searchIndex = fetch(settings.docRoot + '/search-index.gz').then(function (res) {
	        return res.arrayBuffer();
	    });
	    Promise.all([searchIndex]).then(function (_ref) {
	        ...
	        var buf = new buffer.Buffer(idx);
	        var bufferStream = new stream.PassThrough();
	        bufferStream.end(buf);
	        si(options, function (err, _index) {
	            index = _index;
	            index.replicate(bufferStream, function (callback) {
	                console.log('search index ready');
	                emit({
	                    type: _redux.ActionType.InitSearchIndex,
	                    payload: { ready: true }
	                });
	            });
	        });
	...
	function search(payload) {
	    ...
	    index.search(options, function (err, searchResults) {
	        emit({ type: _redux.ActionType.Search, payload: { query: query, searchResults: searchResults } });
	    });
	}
	addEventListener('message', function (e) {
	    var data = e.data;
	    switch (data.type) {
	        case _redux.ActionType.InitSearchIndex:
	            initSearchIndex(data.payload);
	            break;
	        case _redux.ActionType.Search:
	            search(data.payload);
	            break;
	    }
	    ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.connect = exports.actions = exports.ActionType = exports.Provider = undefined;
	...
	exports.ActionType = _actions.ActionType;
	exports.actions = actions;
	var connect = exports.connect = _reactRedux.connect;
	var prevState = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.debouncedSearch = exports.ActionType = undefined;
	exports.isError = isError;
	exports.initSearchIndex = initSearchIndex;
	exports.toggleSearch = toggleSearch;
	exports.search = search;
	exports.changeDisplaySettings = changeDisplaySettings;
	...
	(function (ActionType) {
	    ActionType[ActionType["Navigate"] = 'Navigate'] = "Navigate";
	    ActionType[ActionType["ChangeDisplaySettings"] = 'ChangeDisplaySettings'] = "ChangeDisplaySettings";
	    ActionType[ActionType["ToggleSearch"] = 'ToggleSearch'] = "ToggleSearch";
	    ActionType[ActionType["ChangeSearchQuery"] = 'ChangeSearchQuery'] = "ChangeSearchQuery";
	    ActionType[ActionType["InitSearchIndex"] = 'InitSearchIndex'] = "InitSearchIndex";
	    ActionType[ActionType["Search"] = 'Search'] = "Search";
	})(ActionType || (exports.ActionType = ActionType = {}));
	function isError(payload) {
	    return payload instanceof Error;
	}
	function initSearchIndex(settings) {
	    return {
	...
	function changeDisplaySettings(newSettings) {
	    return {
	        type: ActionType.ChangeDisplaySettings,
	        payload: newSettings
	    };
	}
	var debouncedSearch = exports.debouncedSearch = (0, _utils.debounce)(function (dispatch, query) {
	...
	function navigate(route) {
	    if (route.pkg.indexOf('/') !== -1) {
	        var parts = route.pkg.split('/');
	        var pkg = parts[0];
	        var path = '/' + parts.slice(1).join('/') + route.path;
	        route = Object.assign({}, route, { pkg: pkg, path: path });
	    ...
	    return function (dispatch, getState) {
	        ...
	        var activity = _getState.activity;
	        var service = _getState.service;
	
	        var promise = service.ensureRoute(route).then(function (_ref) {
	            var item = _ref.item;
...
/***/ function(module, exports) {
	...
	function simpleEqual(obj1, obj2) {
	    if (Array.isArray(obj1) && Array.isArray(obj2)) {
	    ...
	    } else if ((typeof obj1 === 'undefined' ? 'undefined' : _typeof(obj1)) === 'object' && !!obj1 && (typeof obj2 === 'undefined' ? 'undefined' : _typeof(obj2)) === 'object' && !!obj2) {
	        ...
	        if (!simpleEqual(keys1, keys2)) {
	            ...
	            for (var _i = 0; _i < keys1.length; _i++) {
	                var _val = obj1[keys1[_i]];
	                var _val2 = obj2[keys1[_i]];
	                if (!simpleEqual(_val, _val2)) {
	                    return false;
	                }
	            }
	        }
